...
--
-- Host: localhost
-- Erstellungszeit: 31. Dezember 2011 um 16:54
...
CREATE TABLE IF NOT EXISTS `modul` (
  ...
  `modul_frequency` set('Jährlich zum Wintersemester','Jährlich zum Sommersemester','jedes Semester') NOT NULL,
...
(65, NULL, 1, 1, '07:30:00', 'Montag', 'jede', 1, 'WS2011', 'gültig'),
(66, NULL, 2, 1, '07:30:00', 'Montag', 'jede', 1, 'WS2011', 'gültig');
...
(2, 'Maschinenbau', 'POSO_2.pdf', 'POSO_2.pdf', '2011-08-01', 'Modul_2.pdf', 1, 'abgestimmt', 'Diplom'),
