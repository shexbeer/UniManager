...
--
-- Host: localhost
-- Erstellungszeit: 04. Jan 2012 um 19:32
...
CREATE TABLE IF NOT EXISTS `aenderungen` (
  ...
  `aenderung_frequency` set('im Wintersemester','im Sommersemester','jedes Semester') NOT NULL DEFAULT 'im Wintersemester',
...
(1, 'praktische Prüfung Informationssysteme', '2011-09-16 12:43:33', 'keine', 1, 1),
(2, 'mündliche Prüfung M-M-K', '2011-09-16 12:45:33', 'erfolgreiches Teilnehmen an den Übungen', 2, 2);
...
(1, '2011-08-06 12:20:29', 1, 1, 1),
(2, '2011-08-10 16:39:31', 3.7, 2, 1),
(5, '2011-10-28 17:47:45', 2, 3, 1),
(7, '2011-10-28 17:48:01', 1, 4, 2),
(8, '2011-10-28 17:47:45', 2, 5, 1),
(9, '2011-09-20 20:47:10', 2, 1, 2),
(10, '2011-12-27 17:14:14', 5, 4, 1);
...
('Sebastian', 'Gasch', 'Winklerstrasse', 09599, 'Freiberg', '20', 'sebastiangasch@gmx.de', '1983-06-14', '1', 'gaschs', 'e155e1bb4a9c38e3baf90637ab7865df', 100, 1),
...
('Markus', 'Kasper', '', 00000, '', '', '', '1989-04-03', '1', 'krellner', '098f6bcd4621d373cade4e832627b4f6', 100, 5),
