...
--
-- Host: localhost
-- Erstellungszeit: 05. August 2011 um 14:12
...
INSERT INTO `modul` (`modul_descr`, `modul_name`, `modul_targetdate`, `modul_id`, `modul_status`, `modul_person_id`, `modul_last_cha`, `modul_mname`, `modul_quarantor`, `modul_institut`, `modul_duration`, `modul_qualifytarget`, `modul_content`, `modul_literature`, `modul_teachform`, `modul_required`, `modul_frequency`, `modul_usability`, `modul_lp`, `modul_conditionforln`, `modul_effort`) VALUES
...
CREATE TABLE IF NOT EXISTS `modulaufstellung` (
  ...
  `mauf_plansemester` varchar(6) NOT NULL,
...
(1, 1, 1, 'SS2011', 'Bachelor'),
(2, 2, 1, 'SS2011', 'Bachelor');
