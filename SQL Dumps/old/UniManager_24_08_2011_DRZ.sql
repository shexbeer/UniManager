...
--
-- Host: localhost
-- Erstellungszeit: 24. August 2011 um 14:02
...
(5, '2011-08-10 19:04:50', NULL, 3, 1),
(7, '2011-08-10 19:26:07', NULL, 4, 2),
(8, '2011-08-10 19:40:18', NULL, 2, 1);
...
INSERT INTO `modulangebot` (`ma_count`, `ma_id`, `ma_modul`, `ma_sg`, `ma_termin`, `ma_lb`, `ma_semester`, `ma_status`) VALUES
(1, NULL, 2, 1, 'Montag 7:30', 1, 'SS2011', 'geprüft');
...
CREATE TABLE IF NOT EXISTS `studiengang` (
  ...
  `sg_status` set('kreiert','konstruiert','beschlossen','abgestimmt','bestätigt') NOT NULL,
  PRIMARY KEY (`sg_id`),
...
(1, 'Bachelor Network Computing', 'POSOBNC.pdf', 'POSOBNC.pdf', '1999-10-01', 'Inhalt nicht verfügbar', 1, 'kreiert'),
(2, 'Diplom Maschinenbau', 'POMB.pdf', 'SOMB.pdf', '2011-08-01', 'mhbMB.pdf', 1, 'bestätigt');
