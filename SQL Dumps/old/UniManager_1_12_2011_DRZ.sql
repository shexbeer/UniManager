...
--
-- Host: localhost
-- Erstellungszeit: 01. Dezember 2011 um 11:13
...
CREATE TABLE IF NOT EXISTS `aenderungen` (
  ...
  `aenderung_note` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `modul` (
  ...
  `modul_last_cha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `modulangebot` (
  ...
  `ma_time` time DEFAULT NULL,
  `ma_weekday` enum('Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag','Sonntag') NOT NULL,
  `ma_week` enum('0','1','2') NOT NULL,
...
INSERT INTO `modulangebot` (`ma_count`, `ma_modul`, `ma_sg`, `ma_time`, `ma_weekday`, `ma_week`, `ma_lb`, `ma_semester`, `ma_status`) VALUES
(1, 2, 1, '00:00:00', 'Montag', '0', 1, 'SS2011', 'geprüft');
...
CREATE TABLE IF NOT EXISTS `rektorat` (
  `rektorat_id` int(3) NOT NULL DEFAULT '0',
